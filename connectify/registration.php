      ...
      <section>
        ...
        <form class="formulario" action="" method="post" enctype="multipart/form-data">
          <div class="Data">
            ...
            <input class="input_texto" id="input" type="text" name="nombre" value="<?=$usernameDefault?>" required>
            <h5>Obligatorio.<h5>
          </div>
          <div class="Data">
            <label for="nombre"><h6>Apellido</h6></label>
            <input class="input_texto" id="input" type="text" name="apellido" value="" required>
            <h5>Obligatorio.<h5>
          </div>
          <div class="Data">
            <label for="email"><h6>Email</h6></label>
            <input class="input_texto" id="input" type="email" name="email" value="" required>
            <h5>Obligatorio.<h5>
          </div>
          <div class="Data">
            <label for="contraseña"><h6>Contraseña</h6></label>
            <input class="input_texto" id="input" type="password" name="contrasenia" value="" required>
            <h5>Obligatorio.<h5>
          </div>
          <div class="Data">
            <label for="nombre"><h6>Repetir Contraseña</h6></label>
            <input class="input_texto" id="input" type="password" name="repetircontrasenia" value="" required>
            <h5>Obligatorio.<h5>
          </div>
          <div class="Data">
